...
- .NET 9 SDK (peut-être obtenu [Ici](https://dotnet.microsoft.com/download/dotnet/9.0) - Prendre le SDK pour votre plateforme, les utilisateurs Linux doivent installer via un gestionnaire de paquets qui fournit le paquet .NET 7)
