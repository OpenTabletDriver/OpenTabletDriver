...
- .NET 9 SDK (can be obtained from [here](https://dotnet.microsoft.com/download/dotnet/9.0) - You want the SDK for your platform, Linux users should install via package manager where possible)
