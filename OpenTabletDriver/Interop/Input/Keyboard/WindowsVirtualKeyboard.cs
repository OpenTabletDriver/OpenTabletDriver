...
namespace OpenTabletDriver.Interop.Input.Keyboard
{
    ...
    public class WindowsVirtualKeyboard : IVirtualKeyboard
    {
        ...
        public static readonly Dictionary<string, VirtualKey> EtoKeysymToVK = new Dictionary<string, VirtualKey>
        {
            ...
            { "Backslash", VirtualKey.VK_OEM_4 },
            { "Plus", VirtualKey.VK_OEM_PLUS },
            { "Equal", VirtualKey.VK_OEM_PLUS },
            { "Semicolon", VirtualKey.VK_OEM_6 },
            { "Quote", VirtualKey.VK_OEM_6 },
            ...
            { "LeftBracket", VirtualKey.VK_OEM_5 },
            { "ContextMenu", VirtualKey.VK_MENU },
