...
namespace OpenTabletDriver.Plugin.Output
{
    ...
    {
        public virtual DigitizerIdentifier Tablet { set; get; }
        ...
        {
            if (report is ITabletReport tabletReport && Tablet.ActiveReportID.IsInRange(tabletReport.ReportID))
        ...
        private void HandlePenBinding(ITabletReport report)
        {
            ...
            {
                float pressurePercent = (float)report.Pressure / Tablet.MaxPressure * 100f;
